...
$grid->addColumn('name', 'ФИО', 'string');  
$grid->addColumn('number', 'Номер сертификата', 'string');  
$grid->addColumn('date', 'Дата выдачи', 'date');  
$grid->addColumn('area', 'Направление деятельности', 'string');  
...
$grid->addColumn('organization', 'Организация', 'string');                                               
$grid->addColumn('action', 'Удаление', 'html', NULL, false, 'id');

#$mydb_tablename = (isset($_GET['db_tablename'])) ? stripslashes($_GET['db_tablename']) : 'registry';
$mydb_tablename = 'registry';
