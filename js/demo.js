...
{ 
	this.editableGrid = new EditableGrid("registry", {
		enableSort: true,
...
this.setCellRenderer("action", new CellRenderer({render: function(cell, id) { 
//				cell.innerHTML += "<a onclick=\"DatabaseGrid.prototype.deleteRow("+id+");\" style=\"cursor:pointer\">" +
//								 "<img src=\"js/images/delete.png\" border=\"0\" alt=\"delete\" title=\"delete\"/></a>";
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=registry");
};
